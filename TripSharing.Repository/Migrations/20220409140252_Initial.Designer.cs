...
namespace TripSharing.Repository.Migrations
{
    ...
    [Migration("20220409140252_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TripSharing.Domain.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TripSharing.Domain.Photo", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)");
            ...
            modelBuilder.Entity("TripSharing.Domain.Comment", b =>
                {
                    b.HasOne("TripSharing.Domain.AppUser", "Author")
                        .WithMany()
